 ...
 * Autor: Prof. José Padilla Duarte y alumnos de cuarto cuatrimestre de TIC
 * Última modificación: 03-Octubre-2017
 *
 * Clase BDMySQL
 * ==============
 * Propósito: Facilitar la interacción de nuestras aplicaciones con el DBMS MySQL
 * 
 * Para que funcione esta clase se requiere:
 * 1) Que esté instalado el MySQL en nuestra PC
 */

using System;
using System.Data;
using System.Windows.Forms;
using MySql.Data.MySqlClient;    // Necesario para acceder a BDs MySQL
